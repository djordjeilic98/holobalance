	...
	public override void OnInspectorGUI()
	{
		...
		if (lsdTarget.isPreprocessed)
		{
			...
			if (GUILayout.Button("Remove Pre-processed Data", GUILayout.Height(30)))
			{
				...
				{
					lsdTarget.isPreprocessed = false;
					lsdTarget.indexBlendables = null;
					lsdTarget.animCurves = null;
					lsdTarget.bones = null;
					lsdTarget.boneCurves = null;
					lsdTarget.boneNeutralPositions = null;
					lsdTarget.boneNeutralRotations = null;
					lsdTarget.boneNeutralScales = null;
				}
			}
