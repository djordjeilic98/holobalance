...
namespace HoloKit
{
    public class Profile
    {
        ...
        private static readonly Model ModelHoloKitHolobalance = new Model
        {
            eyeDistance = 0.065f,
            mrOffset = new Vector3(0f, -0.041f, -0.092f),
            fieldOfView = 0f,
            distortion = 0f,
            viewWidth = 0.0696f,
            viewHeight = 0.0648f,
        ...
        private static readonly Phone PhoneGooglePixel3XL = new Phone
        {
            screenWidth = 0.22f,
            screenHeight = 0.107f,
            screenBottom = 0.0045f,
            cameraOffset = new Vector3(0.06f, -0.055f, -0.009f)
        };
        ...
        private static readonly Phone PhoneNote9 = new Phone
        {
            screenWidth = 0.146f,
            screenHeight = 0.073f,
            screenBottom = 0.0015f,
        ...
        public static Profile GetProfile(ModelType modelType, PhoneType phoneType)
        {
            ...
            switch (modelType)
            {
                ...
                case ModelType.HoloKitApple:
                    ...
                    break;
                case ModelType.HoloKitHolobalance:
                    result.model = ModelHoloKitHolobalance;
                    break;
                default:
                    result.model = ModelHoloKitv1;
                    break;
            ...
            switch (phoneType)
            {
                ...
                case PhoneType.GooglePixel2XL:
                    ...
                    break;
                case PhoneType.GooglePixel3XL:
                    result.phone = PhoneGooglePixel3XL;
                    break;
                case PhoneType.SamsungS8:
                    result.phone = PhoneSamsungS8;
                    break;
                case PhoneType.SamsungNote9:
                    result.phone = PhoneNote9;
                    break;
                default:
        ...
        public static Profile GetProfile(ModelType modelType)
        {
            ...
            switch (sDeviceModel)
            {
                ...
                case "samsung SM-G950F":
                    ...
                    break;
                case "samsung SM-N960F":
                    phoneType = PhoneType.SamsungNote9;
                    Debug.Log("HoloKit: Loaded configuration for Samsung Note9");
                    break;
                default:
                    phoneType = PhoneType.Unknown;
                    Debug.LogWarning(
